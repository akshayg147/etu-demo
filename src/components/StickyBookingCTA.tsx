...
const StickyBookingCTA = () => {
  ...
  return (
    <motion.div
      style={{ opacity }}
      className="fixed bottom-6 right-6 z-50 md:hidden flex flex-col gap-3 items-end"
    >
      <a
      ...
      <a href="#contact">
        <button className="bg-gold text-background px-6 py-4 font-body font-bold text-sm uppercase tracking-widest animate-pulse-gold shadow-lg">
          Book VIP Session
        </button>
      </a>
    </motion.div>
